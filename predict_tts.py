...
if __name__ == '__main__':
    ...
    parser.add_argument('--lang', '-l', dest='lang',default='ar', action='store_true')
    ...
    for i, text_line in enumerate(text):
        ...
        phons = backend.phonemize(text_line)
        # phons = " ".join([char*20 for char in 'ǀǃ'])
        print('phons0 = ',phons)
        phons = phons.replace("ˤ","").replace("t̪","t").replace("s̪","s")
        print('phons1 = ',phons)
